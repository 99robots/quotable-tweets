...
class NNRobots_Quotable_Tweets extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id("bitly_access_token"); ?>" name="<?php echo $this->get_field_name("bitly_access_token"); ?>" type="text" value="<?php echo esc_attr($bitly_access_token); ?>">
            <br />
